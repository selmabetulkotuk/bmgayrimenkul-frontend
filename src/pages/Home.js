...
import { Search, TrendingUp, Shield, Clock, ArrowRight, Home as HomeIcon, Building, Store, MapPin } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Yılların deneyimi ile güvenilir ve profesyonel gayrimenkul danışmanlığı'
    },
    {
      icon: <TrendingUp className="h-8 w-8" />,
      title: 'Geniş Portföy',
      description: 'Karaman\'ın en geniş gayrimenkul portföyü ile hizmetinizdeyiz'
    },
    {
      icon: <Clock className="h-8 w-8" />,
      title: 'Hızlı İşlemler',
      description: 'Alım-satım ve kiralama işlemleriniz için hızlı çözümler sunuyoruz'
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Öne Çıkan İlanlar</h2>
            <p className="text-lg text-gray-600">Sizin için seçtiğimiz en iyi gayrimenkuller</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Neden Berk Mutlu Emlak?</h2>
            <p className="text-lg text-gray-600">Hayalinizdeki evi bulmak için en iyi seçim</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href={`tel:${companyInfo.phone}`}>
              <Button size="lg" variant="outline" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 shadow-xl">
                Hemen Ara
              </Button>
            </a>
          </div>
