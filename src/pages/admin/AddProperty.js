      ...
      <div className="bg-white shadow-xl rounded-2xl w-full max-w-4xl p-8">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <textarea
            ...
            className="border rounded-lg p-3 focus:ring-2 focus:ring-blue-400 outline-none md:col-span-2"
          />
          ...
          <button
            type="submit"
            className="md:col-span-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 rounded-lg shadow-lg hover:from-blue-700 hover:to-blue-800 transition"
          >
            İlanı Kaydet
          </button>
        </form>
